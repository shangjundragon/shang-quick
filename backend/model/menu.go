...
type SysMenu struct {
	...
	MenuType   int     `dbw:"column:menu_type;default:0;tableUpdateStrategy:always" json:"menuType"`
	...
	IsFrame    int     `dbw:"column:is_frame;default:0;tableUpdateStrategy:always" json:"isFrame"`
	IsCache    int     `dbw:"column:is_cache;default:0;tableUpdateStrategy:always" json:"isCache"`
	IsVisible  int     `dbw:"column:is_visible;default:1;tableUpdateStrategy:always" json:"isVisible"`
